...
* @property {string} req.body.username - Nome de usuário
* @property {string} req.body.password - Senha do usuário
...
* @property {string} req.body.username - Primeiro nome do usuário
* @property {string} req.body.password - Ultimo nome do usuário
* @property {string} req.body.email -E-mail do usuário
* @return {User}
*/
